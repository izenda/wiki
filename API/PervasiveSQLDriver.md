...
|String|[[CacheKeyBase|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_Driver_CacheKeyBase]]|Gets a [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] that represents a unique key that can be used to query the cache.|PervasiveSQLDriver|
...
|String|[[ConnectionString|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_Driver_ConnectionString]]| Represents the default connection string for the driver in use. |String.Empty|
...
|String|[[DefaultSchemaName|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_Driver_DefaultSchemaName]]| Represents the name of the default schema of the DBMS for this driver. |String.Empty|
...
|Version|[[Version|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_Driver_Version]]| Gets the version of the database that is being connected to. Once the version has been obtained, its value will be cached to disk. |0.0|
...
###DateTimeNow()
Gets the [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the PSQL command to return the current system date from the database server.
...
###FullStoredProceduresList()
 Gets a list of all stored procedures on the PSQL database. 
...
Creates an [[System.Data.IDbCommand|http://msdn.microsoft.com/en-us/library/bt2afddc]] object from the specified AdHoc.Report.

Parameters: 

* [[Izenda.AdHoc.Report|/API/Izenda/AdHoc/Izenda-AdHoc-Report]] report  - The AdHoc.Report to generate a database command for.
...
The [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] represetation of the description that has been made safe for executing in PSQL.
...
* [[Izenda.AdHoc.Report|/API/Izenda/AdHoc/Izenda-AdHoc-Report]] report  - The AdHoc.Report that will be used to generate the command for.
...
###GetColumns(Izenda.AdHoc.Database.Table)
 Gets the complete list of columns found on the PSQL database for the specified table. 

Parameters: 

* [[Izenda.AdHoc.Database.Table|/API/Izenda/AdHoc/Database/Izenda-AdHoc-Database-Table]] table  - The [[Table|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_Column_Table]] to find columns for.
...
The [[SqlType|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_Column_SqlType]] array corresponding to the columns found.
...
###GetConstraints(Izenda.AdHoc.Database.DatabaseSchema)
 Gets a list of constraints for the specified database schema on the PSQL database. 

Parameters: 

* [[Izenda.AdHoc.Database.DatabaseSchema|/API/Izenda/AdHoc/Database/Izenda-AdHoc-Database-DatabaseSchema]] schema  - The [[DatabaseSchema|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_Driver_DatabaseSchema]] to get the constraints for.
...
The [[PrimaryColumn|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_Constraint_PrimaryColumn]] array corresponding to the database constraints found.
...
Gets a SQL formatted [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the function used to convert the specified parameters into an PSQL date.
...
The SQL statement that can be executed to construct an PSQL formatted date from the parts provided.
...
Gets a PSQL statement from the specified parameters that creates a [[System.Data.IDbCommand|http://msdn.microsoft.com/en-us/library/bt2afddc]] to create a report on the database.
...
Gets a PSQL statement from the specified parameters that creates a [[System.Data.IDbCommand|http://msdn.microsoft.com/en-us/library/bt2afddc]] to create a report on the database. This method uses an empty tenantId.
...
* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] part  - The PSQL function to use to convert the expression.
* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] expression  - he expression that should be used to extract the specified portion of the date from.
...
Gets a [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the specified date part and SQL expression formatted to be executed in PSQL.

Parameters: 

* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] part  - The name of the PSQL date function to use to convert the expression.
* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] expression  - The expression that should be used to extract the specified portion of the date from.
...
Gets a PSQL statement from the specified parameters that creates a [[System.Data.IDbCommand|http://msdn.microsoft.com/en-us/library/bt2afddc]] to delete the specified report definition from the database.
...
Gets a PSQL statement from the specified parameters that creates a [[System.Data.IDbCommand|http://msdn.microsoft.com/en-us/library/bt2afddc]] to get a list of reports from the database.
...
Gets an PSQL statement from the specified parameters that creates a [[System.Data.IDbCommand|http://msdn.microsoft.com/en-us/library/bt2afddc]] to load the specified report definition from the database.
...
Gets a PSQL statement from the specified parameters that creates a [[System.Data.IDbCommand|http://msdn.microsoft.com/en-us/library/bt2afddc]] to load the specified report definition with the specified name and tenantId from the database.
...
Gets a SQL formatted [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] of a PSQL statement to extract the quarter number from the specified SQL expression.

Parameters: 

* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] expression  - The PSQL [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] that the quarter should be extracted from.
...
Gets the [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the fully-qualified name of the table formatted for PSQL.

Parameters: 

* [[Izenda.AdHoc.Database.Table|/API/Izenda/AdHoc/Database/Izenda-AdHoc-Database-Table]] table  - The [[Table|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_Column_Table]] to get the fully-qualified name of.
...
Gets the [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the fully-qualified name of the column formatted for PSQL.

Parameters: 

* [[Izenda.AdHoc.Database.Column|/API/Izenda/AdHoc/Database/Izenda-AdHoc-Database-Column]] column  - The [[SqlType|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_Column_SqlType]] to get the fully-qualified name of.
...
###GetTopNSql(System.String,System.Int32)
 Creates a TOP statement to be used with the specified PSQL expression to select the number of records specified. 

Parameters: 

* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] sql  - The PSQL statement that will receive the TOP statement.
...
The [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] PSQL statement with the appended TOP n records.
...
Gets a [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the specified PSQL expression CAST to a string.

Parameters: 

* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] expression  - The PSQL expression that should be cast to a string type.
...
The [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the PSQL statement.
...
Gets a PSQL statement from the specified parameters that creates a [[System.Data.IDbCommand|http://msdn.microsoft.com/en-us/library/bt2afddc]] to update a report on the database.
...
Gets a PSQL statement from the specified parameters that creates a [[System.Data.IDbCommand|http://msdn.microsoft.com/en-us/library/bt2afddc]] to update a report on the database. This method uses an empty tenantId.
...
Gets a SQL formatted [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the PSQL WEEK function to extract the week from the specified SQL expression.

Parameters: 

* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] expression  - The PSQL [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] that the week should be extracted from.
...
The SQL formatted [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] that can be executed to extract the week from the expression.
...
Gets a SQL formatted [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of a PSQL function to extract the year and week from the specified SQL expression.

Parameters: 

* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] expression  - The PSQL [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] that the year and week should be extracted from.
...
Gets a [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the specified value that will be formatted to be acceptible as a PSQL identifier.

Parameters: 

* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] str  - The table, view, or column name to be formatted as a PSQL identifier
...
The value specified with PSQL style identifier notation.
