...
|String|[[CacheFolder|/API/CodeSamples/CacheFolder]]|Gets or sets the folder where cache is stored|Path.GetTempPath|
...
|String|[[ReportsPath|/API/CodeSamples/ReportsPath]]|Gets or sets the path of the folder where             stores its reports.            If the value is  then reports will be stored            in "Reports" subfolder of application folder.|ServerPath\Reports|
...
|String|[[TemplatesPath|/API/CodeSamples/TemplatesPath]]|Gets or sets the path of the folder where templates are stored.|ServerPath\Reports|
