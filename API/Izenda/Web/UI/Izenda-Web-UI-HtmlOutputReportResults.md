...
|String|[[DashboardDesignUrlTemplate|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportViewer_DashboardDesignUrlTemplate]]| Gets or sets the javascript function call to navigate to the dashboard designer for the currently loaded report. |javascript:AdHoc.Utility.NavigateReport('DashboardDesigner.aspx?rn={0}', 0, 'rs.aspx?');|
...
|String|[[DesignUrlTemplate|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportViewer_DesignUrlTemplate]]| Gets or sets the javascript function call to navigate to the report designer for the currently loaded report. |javascript:AdHoc.Utility.NavigateReport('ReportDesigner.aspx?rn={0}', 0, 'rs.aspx?');|
...
|String|[[ReportName|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportViewer_ReportName]]| Gets or sets the name of the report that is being displayed to this control. |null|
...
|AdHocToolbarNavigation|[[Toolbar|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportViewer_Toolbar]]|Gets the [[Izenda.Web.UI.AdHocToolbarNavigation|/API/Izenda/Web/UI/Izenda-Web-UI-AdHocToolbarNavigation]] control associated with the classic Report Viewer.|null|
...
|Int32|[[UseSimpleViewer|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportViewer_UseSimpleViewer]]| Determines whether to use a simplified ReportViewer with no toolbar or filters. Zero specifies the full ReportViewer should be used. |null|
