...
|:-------|:----------:|:-----------------:|:-----------:|
|PlaceHolder|[[AboveTabsArea|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_TabbedControl_AboveTabsArea]]| Gets a placeholder for the control content that is loaded when this tab is active. |null|
...
|String|[[JavaScriptOnBeforeTabChangedFunction|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_TabbedControl_JavaScriptOnBeforeTabChangedFunction]]| Gets or sets the javascript function that will be called before switching between tabs. |null|
|String|[[JavaScriptOnTabChangedFunction|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_TabbedControl_JavaScriptOnTabChangedFunction]]| Gets or sets the javascript function that will be called when switching between tabs. |null|
...
|TabStrip|[[TabStrip|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_TabbedControl_TabStrip]]|Gets the [[Izenda.Web.UI.TabStrip|/API/Izenda/Web/UI/Izenda-Web-UI-TabStrip]] control that this tab belongs to.|null|
...
###AddTab(System.Web.UI.Control,System.String,System.String)
Adds a tab with the specified parameters to the [[Izenda.Web.UI.TabStrip|/API/Izenda/Web/UI/Izenda-Web-UI-TabStrip]] control.

Parameters: 

* [[System.Web.UI.Control|http://msdn.microsoft.com/en-us/library/983zwx2h]] content  - The content control that will be hidden/shown when the tab is toggled.
* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] tabName  - The logical name that will be given to the tab.
* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] tabTitle  - The displayed text that will be shown on the tab.
...
The tab that was created and added to the control.
...
###SetActiveTab(System.String)
 Sets the tab with the specified name as the active tab. 

Parameters: 

* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] tabName  - The logical name of the tab to set as the active one.
