...
|:-------|:----------:|:-----------------:|:-----------:|
|Boolean|[[AllowNulls|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_JoinedTablesList_AllowNulls]]| Determines whether the "Allow Nulls" checkbox is displayed on the control. |False|
...
|Boolean|[[Distinct|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_JoinedTablesList_Distinct]]| Determines whether the "Distinct" checkbox is displayed on the control. |True|
...
|JoinedTableCollection|[[Items|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_JoinedTablesList_Items]]|Gets a collection of [[Izenda.AdHoc.JoinedTable|/API/Izenda/AdHoc/Izenda-AdHoc-JoinedTable]] items.|null|
