...
|String|[[SavedReportCategory|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_DashboardDesignerControl_SavedReportCategory]]| Gets the category of the report that was most recently loaded by the user. |null|
|String|[[SavedReportCategoryParam|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_DashboardDesignerControl_SavedReportCategoryParam]]| Gets the category of the report that was provided through the web request parameters. |String.Empty|
|String|[[SavedReportName|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_DashboardDesignerControl_SavedReportName]]| Gets the name of the report that was most recently loaded by the user. |null|
|String|[[SavedReportNameParam|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_DashboardDesignerControl_SavedReportNameParam]]| Gets the name of the report that was provided through the web request parameters. |String.Empty|
...
|AdHocToolbarNavigation|[[Toolbar|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_DashboardDesignerControl_Toolbar]]| Represents the toolbar that is displayed on the dashboard designer page and has specific controls disabled by default. |null|
...
###GetEmbeddedFile(System.Reflection.Assembly,System.String)
Gets a [[System.IO.Stream|http://msdn.microsoft.com/en-us/library/8f86tw9e]] containing the resource from the specified [[System.Reflection.Assembly|http://msdn.microsoft.com/en-us/library/xbe1wdx9]].

Parameters: 

* [[System.Reflection.Assembly|http://msdn.microsoft.com/en-us/library/xbe1wdx9]] assembly  - The [[System.Reflection.Assembly|http://msdn.microsoft.com/en-us/library/xbe1wdx9]] with embedded resources to pull from.
* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] fileName  - The name of the file within the assembly.
...
A [[System.IO.Stream|http://msdn.microsoft.com/en-us/library/8f86tw9e]] containing the data of the resource.


---


###GetEmbeddedFile(System.String,System.String)
Gets a [[System.IO.Stream|http://msdn.microsoft.com/en-us/library/8f86tw9e]] containing the data of the resource from the assembly with the specified name.

Parameters: 

* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] assemblyName  - The [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the name of the assembly.
* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] fileName  - The [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the file name for the resource.
...
Loads a file from the embedded resources with the given name and returns the [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the resource.

Parameters: 

* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] resourceName  - The internal identifying name of the resource to load.
...
The [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the loaded resource.
