...
|Boolean|[[AutoPostback|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ToolbarButton_AutoPostback]]| Determines whether clicking this toolbar button will automatically cause a postback to the server to occur. When true then the click event triggered will be the one defined with the button_ServerClick method. |True|
...
|String|[[ButtonWidth|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ToolbarButton_ButtonWidth]]| Gets or sets the width of the toolbar button. |null|
|String|[[ClientID|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ToolbarItem_ClientID]]||String.Empty|
...
|String|[[HRef|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ToolbarButton_HRef]]| Gets or sets the link information that will be registered to the onclick event for this toolbar item. |null|
...
|String|[[ImageName|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ToolbarButton_ImageName]]| Gets or sets the name of the internal image resource that will be used on this toolbar item. |null|
|String|[[ImageUrl|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ToolbarButton_ImageUrl]]| Gets or sets the resource URL to the image that will be displayed on this toolbar item. |null|
...
|RedirectMethod|[[RedirectMethod|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_AdHocToolbarButton_RedirectMethod]]|Gets or sets [[Izenda.Web.UI.RedirectMethod|/API/Izenda/Web/UI/Izenda-Web-UI-RedirectMethod]] of the button that determines the behavior of redirecting to another page from this control.|Window|
|String|[[RedirectUrl|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_AdHocToolbarButton_RedirectUrl]]| Gets or sets the URL that this button will redirect to when it is clicked. |null|
