...
|String|[[CurrentFolder|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportList_CurrentFolder]]| Gets the folder the current report will be put into when saving or updating the report. |String.Empty|
...
|String|[[DesignNewDashText|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportList_DesignNewDashText]]|Gets or sets the text for the "Design New Dashboard" button on the Reports Tab of the [[Izenda.Web.UI.AdHocReportDesigner|/API/Izenda/Web/UI/Izenda-Web-UI-AdHocReportDesigner]].|<STRONG>Design A New Dashboard</STRONG>|
|String|[[DesignNewText|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportList_DesignNewText]]|Gets or sets the text for the "Design New Report" button on the Reports Tab of hte [[Izenda.Web.UI.AdHocReportDesigner|/API/Izenda/Web/UI/Izenda-Web-UI-AdHocReportDesigner]].|<STRONG>Design A New Report</STRONG>|
|String|[[DesignUrlTemplate|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportList_DesignUrlTemplate]]|Gets or sets the URL template for designing to a report via links on the Reports Tab of the [[Izenda.Web.UI.AdHocReportDesigner|/API/Izenda/Web/UI/Izenda-Web-UI-AdHocReportDesigner]].|javascript:AdHoc.Utility.NavigateReport("[DesignerUrl]rn={0}", 0, 'rs.aspx?');|
...
|String|[[HeaderText|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportList_HeaderText]]|Gets or sets the header text of the [[Izenda.Web.UI.AdHocReportDesigner|/API/Izenda/Web/UI/Izenda-Web-UI-AdHocReportDesigner]] for all tabs except the Reports Tab.|<STRONG>Reports - </STRONG>A list of saved reports.&nbsp; Click on the report name to view the report or click 'Design' to open the report in the designer.|
...
|Boolean|[[InReportsTab|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportList_InReportsTab]]|Determines whether the user has navigated to the Reports Tab of the [[Izenda.Web.UI.AdHocReportDesigner|/API/Izenda/Web/UI/Izenda-Web-UI-AdHocReportDesigner]].|False|
...
|Boolean|[[RenderControl|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportList_RenderControl]]| Determines whether the control is rendered or not. |True|
|Version|[[RenderingCompatibility|http://msdn.microsoft.com/en-us/library/dd992688]]||4.0|
|String|[[ReportsPath|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportList_ReportsPath]]| Gets or sets the physical path to the folder where reports are stored on the server for this report. |[drive]:\[ApplicationFolder]\Reports|
|Boolean|[[ShowDesignNew|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportList_ShowDesignNew]]|Determines whether the "Design New report" button is displayed on the Reports Tab of the [[Izenda.Web.UI.AdHocReportDesigner|/API/Izenda/Web/UI/Izenda-Web-UI-AdHocReportDesigner]].|True|
