...
|:-------|:----------:|:-----------------:|:-----------:|
|Tab|[[ActiveTab|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_TabStrip_ActiveTab]]| Gets or sets the tab that will be active when the control is rendered. |null|
|Int32|[[ActiveTabIndex|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_TabStrip_ActiveTabIndex]]| Gets or sets the index of the active tab. |0|
...
|TabCollection|[[Items|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_TabStrip_Items]]| Gets the collection of tabs on this Tab Strip. |{}|
...
|String|[[OnTabActivate|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_TabStrip_OnTabActivate]]| Gets the name of the javascript method that will be called when the tab is activated. |null|
...
|TabCollection|[[Tabs|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_TabStrip_Tabs]]| Gets the collection of individual tabs registered to this Tab Strip. |{}|
|String|[[TabsCss|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_TabStrip_TabsCss]]| Gets or sets the CSS stylesheet that will be applied to the tabs in the Tab Strip. |@import url(Resources/css/tabs.css);|
