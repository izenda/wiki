...
|Int32|[[ClientTimeZone|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_DropDownDateTime_ClientTimeZone]]| Gets or sets the timezone offset of the client from the server's timezone. |0|
...
|DateTime|[[Value|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_DropDownDateTime_Value]]| Gets or sets the initial value of the control when it is rendered to the page. |null|
