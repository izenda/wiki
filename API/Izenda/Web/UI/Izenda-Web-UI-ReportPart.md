...
|Boolean|[[CombineScripts|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportPart_CombineScripts]]| Determines whether javascript resource references will be combined down to a single line. |False|
...
|String|[[Part|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportPart_Part]]| Gets or sets the part of the report to render. |String.Empty|
|Version|[[RenderingCompatibility|http://msdn.microsoft.com/en-us/library/dd992688]]||4.0|
|String|[[Report|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportPart_Report]]| Gets or sets the full name of the report that will be used for rendering the individual part of the report desired. |String.Empty|
|ResourcesInclusion|[[ResourcesInclusion|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportPart_ResourcesInclusion]]| Gets or sets the method of resource inclusion that will be used in this ReportPart. |Embedded|
|String|[[ResponseServerPath|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportPart_ResponseServerPath]]| Gets or sets the path to the response server page that this ReportPart will use to locate the information for the report. |rs.aspx|
