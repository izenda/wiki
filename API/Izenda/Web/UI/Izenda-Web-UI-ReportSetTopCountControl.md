...
|String|[[OnChange|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportSetTopCountControl_OnChange]]| Gets or sets the javascript method that fires when the selection in the dropdown menu changes. |null|
...
|Int32|[[RowCount|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportSetTopCountControl_RowCount]]| Gets or sets the default option that is selected for this dropdown and updates the report's "Top" property if needed. |100|
|Boolean|[[ShowAllOption|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_ReportSetTopCountControl_ShowAllOption]]| Determines whether the "All" option is present in the list of options. |True|
...
###AttachToRenderer(Izenda.Web.UI.HtmlReportRenderer)
Attaches a client script to the "OnChange" method that allows the [[Izenda.Web.UI.AdHocReportDesigner|/API/Izenda/Web/UI/Izenda-Web-UI-AdHocReportDesigner]] to update the page specified with the content when the row count is changed.

Parameters: 

* [[Izenda.Web.UI.HtmlReportRenderer|/API/Izenda/Web/UI/Izenda-Web-UI-HtmlReportRenderer]] renderer  - The [[Izenda.Web.UI.HtmlReportRenderer|/API/Izenda/Web/UI/Izenda-Web-UI-HtmlReportRenderer]] containing the page accessible in the same context to switch to when the row count is updated.
