...
|:-------|:----------:|:-----------------:|:-----------:|
|String|[[AlterSaveAsButtonCaption|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_AdHocToolbarNavigation_AlterSaveAsButtonCaption]]| Gets or sets the text that will be displayed on the Save As button. When set, this overrides the default text on the button. |String.Empty|
...
|Boolean|[[IsReportViewerControl|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_AdHocToolbarNavigation_IsReportViewerControl]]|Gets or sets a value indicating whether this instance is [[Izenda.Web.UI.ReportViewer|/API/Izenda/Web/UI/Izenda-Web-UI-ReportViewer]] child control.|False|
|ToolbarItem|[[Item|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_AdHocToolbarNavigation_Item_-_System_String_-_]]|Gets the item contained in the underlying [[Izenda.Web.UI.Toolbar|/API/Izenda/Web/UI/Izenda-Web-UI-Toolbar]] by its identifying name.|null|
|ToolbarItemsCollection|[[Items|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_AdHocToolbarNavigation_Items]]|Gets a collection of [[Izenda.Web.UI.ToolbarItem|/API/Izenda/Web/UI/Izenda-Web-UI-ToolbarItem]] controls that are contained on the underlying [[Izenda.Web.UI.Toolbar|/API/Izenda/Web/UI/Izenda-Web-UI-Toolbar]].|{}|
...
|ReportSetType|[[NewButtonType|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_AdHocToolbarNavigation_NewButtonType]]|Gets or sets the [[Izenda.AdHoc.ReportSetType|/API/Izenda/AdHoc/Izenda-AdHoc-ReportSetType]] that will be used to determine how the New report button will behave on the toolbar.|ReportDesigner|
...
|Boolean|[[ShowAddReportButton|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_AdHocToolbarNavigation_ShowAddReportButton]]| Determines whether the Add Report button will be displayed on the toolbar. |False|
|Boolean|[[ShowAdminButton|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_AdHocToolbarNavigation_ShowAdminButton]]| Determines whether the settings button that navigates to the settings page is displayed on the toolbar. |True|
|Boolean|[[ShowBackButton|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_AdHocToolbarNavigation_ShowBackButton]]| Determines whether the back button used to navigate backward to the last page is displayed on the toolbar. |False|
|Boolean|[[ShowExportButtons|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_AdHocToolbarNavigation_ShowExportButtons]]| Determines whether certain buttons related to exporting the report will be displayed on the toolbar. |True|
|Boolean|[[ShowGoButton|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_AdHocToolbarNavigation_ShowGoButton]]| Determines whether the Go button is displayed on the toolbar that runs the current report in a new report viewer window. |False|
|Boolean|[[ShowNewButton|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_AdHocToolbarNavigation_ShowNewButton]]| Determines whether the new report button is displayed on the toolbar. |True|
|Boolean|[[ShowPrintButton|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_AdHocToolbarNavigation_ShowPrintButton]]| Determines whether the Print HTML button is displayed on the toolbar. |False|
|Boolean|[[ShowSaveAsButton|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_AdHocToolbarNavigation_ShowSaveAsButton]]| Determines whether the Save As button is displayed on the toolbar. |True|
