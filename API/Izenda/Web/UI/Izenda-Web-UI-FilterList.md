...
|String|[[FieldChangedHandler|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_FilterList_FieldChangedHandler]]|Gets the javascript function that is called when a field is changed on the Filter Tab of the [[Izenda.Web.UI.AdHocReportDesigner|/API/Izenda/Web/UI/Izenda-Web-UI-AdHocReportDesigner]].|CC_OnFieldsListChangedHandler|
|String|[[FieldInitialized|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_FilterList_FieldInitialized]]|Gets the javascript function that is called when the fields are initialized on the Filter Tab of the [[Izenda.Web.UI.AdHocReportDesigner|/API/Izenda/Web/UI/Izenda-Web-UI-AdHocReportDesigner]].|CC_OnFieldsListInitialized|
|String|[[FilterLogicValue|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_FilterList_FilterLogicValue]]|Gets or sets the text that will be displayed by default for the Filter Logic text field on the Filter Tab of the [[Izenda.Web.UI.AdHocReportDesigner|/API/Izenda/Web/UI/Izenda-Web-UI-AdHocReportDesigner]].|String.Empty|
|String|[[FValue|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_FilterList_FValue]]|Get or sets the value that is selected by default on the Filter Tab of the [[Izenda.Web.UI.AdHocReportDesigner|/API/Izenda/Web/UI/Izenda-Web-UI-AdHocReportDesigner]].|None|
...
|FilterCollection|[[Items|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_FilterList_Items]]|Gets or sets the collection of [[Izenda.AdHoc.Filter|/API/Izenda/AdHoc/Izenda-AdHoc-Filter]] items available for selection on this control.|null|
...
|String|[[OnClientFilterChanged|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_FilterList_OnClientFilterChanged]]| Gets or sets the javascript function that will be run when the value of the filter is changed on the client web browser. |null|
...
|Boolean|[[ShowReportParameters|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_FilterList_ShowReportParameters]]|Determines whether the Show Report Parameters option is displayed on the Filter Tab of the [[Izenda.Web.UI.AdHocReportDesigner|/API/Izenda/Web/UI/Izenda-Web-UI-AdHocReportDesigner]].|False|
|Boolean|[[SimpleMode|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_FilterList_SimpleMode]]| Determines whether the controls for the Filters will display in a simplified version that doesn't allow the filter column and operator to change. |False|
...
|String|[[TableChangedHandler|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_FilterList_TableChangedHandler]]|Gets the javascript method that fires when the data sources are changed on the [[Izenda.Web.UI.AdHocReportDesigner|/API/Izenda/Web/UI/Izenda-Web-UI-AdHocReportDesigner]].|CC_OnTableListChangedHandler|
|String|[[TableInitialized|/API/Izenda/Web/UI/CodeSamples/Izenda_Web_UI_FilterList_TableInitialized]]|Gets the javascript function that is called when the list of tables is initialized on the Filter Tab of the [[Izenda.Web.UI.AdHocReportDesigner|/API/Izenda/Web/UI/Izenda-Web-UI-AdHocReportDesigner]].|CC_OnTableListInitialized|
...
###UpdateControlState()
 Called when the page is re-loading to ensure the control maintains state across the request. 
...
###UpdateReportSet()
Called when the control is initialized and when the mode is switched between checkbox mode and advanced mode on the Data Sources Tab of the [[Izenda.Web.UI.AdHocReportDesigner|/API/Izenda/Web/UI/Izenda-Web-UI-AdHocReportDesigner]]. This updates the state of the report filters when the page is reloaded.
