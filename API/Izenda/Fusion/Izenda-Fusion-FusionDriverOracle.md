...
|String|[[AsForTables|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_OracleDriver_AsForTables]]| Gets the Oracle keyword used to separate identifiers from aliases. |String.Empty|
|String|[[CacheKeyBase|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_Driver_CacheKeyBase]]|Gets a [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] that represents a unique key that can be used to query the cache.|Izenda.Fusion.FusionDriverOracle|
|Int32|[[CmdTimeout|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_OracleDriver_CmdTimeout]]| Gets the timeout for Oracle queries. |3600|
...
|FusionConnection|[[DefaultConnection|/API/Izenda/Fusion/CodeSamples/Izenda_Fusion_FusionDriverOracle_DefaultConnection]]||null|
...
|Boolean|[[OnlyNullIsBlank|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_OracleDriver_OnlyNullIsBlank]]||True|
