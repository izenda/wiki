...
|String|[[CacheKeyBase|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_Driver_CacheKeyBase]]|Gets a [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] that represents a unique key that can be used to query the cache.|Izenda.Fusion.FusionDriverMySql|
...
|String|[[DatabaseName|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_MySqlDriver_DatabaseName]]| Gets the name of the database specified in the ConnectionString. |null|
...
|FusionConnection|[[DefaultConnection|/API/Izenda/Fusion/CodeSamples/Izenda_Fusion_FusionDriverMySql_DefaultConnection]]||null|
...
|Boolean|[[SupportsCreateDateExpression|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_MySqlDriver_SupportsCreateDateExpression]]| Determines if the version of MySQL supports the ability to create a date from portions of a date. |null|
...
###AddConnection(System.String,Izenda.Fusion.FusionConnectionType,System.String)
 Adds a new database or OData connection to the list of connections registered with this driver.  
...
* [[Izenda.Fusion.FusionConnectionType|/API/Izenda/Fusion/Izenda-Fusion-FusionConnectionType]] fusionConnectionType  - The type of database that this connection will connect to.
* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] getSchemaUrl  - The connection string or webservice URL that will be used to connect to the database.
...
###AddMySqlConnection(System.String,System.String)
 Adds a MySQL connection with the specified alias and connection string to the collection of registered connections. 
...
###AddOracleConnection(System.String,System.String)
 Adds an Oracle connection with the specified alias and connection string to the collection of registered connections. This cannot be the default connection. 
...
###DetectVersion()
 Gets the version of the first MySQL database that is registered in the list of connections. 
...
###GetConstraints(Izenda.AdHoc.Database.DatabaseSchema)
 Gets a list of constraints for the specified database schema that contains information about each MySQL database being connected to. 
...
Constructs a [[Izenda.Fusion.FusionDriverMySql|/API/Izenda/Fusion/Izenda-Fusion-FusionDriverMySql]] object from an existing [[Izenda.AdHoc.Database.MySqlDriver|/API/Izenda/AdHoc/Database/Izenda-AdHoc-Database-MySqlDriver]].
...
###RemoveConstraintSimple(System.String,System.String)
