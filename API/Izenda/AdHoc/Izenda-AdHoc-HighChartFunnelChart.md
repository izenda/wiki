...
|ChartPropertyCollection|[[Properties|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_Chart_Properties]]| Gets the collection of chart properties that are used to control various settings. |{ShowPercentage, ShowValue,<br>ShowSliceLabels, Scale,<br>Mode, TargetReport,<br>HiddenEffectField, Effect,<br>ThirdMode, CountInRow}|
...
###CreateDataGenerator()
 Gets the mechanism for this funnel chart that loads and formats data. 
...
A new [[Izenda.AdHoc.FunnelChartDataGenerator|/API/Izenda/AdHoc/Izenda-AdHoc-FunnelChartDataGenerator]] to be used with the chart for loading labels and values.
...
###Render(Izenda.AdHoc.Report,System.String)
 Initializes the configuration options for the funnel chart using the specified parameters. 
