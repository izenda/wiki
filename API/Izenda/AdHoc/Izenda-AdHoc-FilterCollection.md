...
|String|[[FilterLogicValue|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_FilterCollection_FilterLogicValue]]| Gets or sets the filter logic value for this collection of filters. |String.Empty|
...
|Filter|[[Item|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_FilterCollection_Item_-_System_Int32_-_]]|Gets or sets the [[Izenda.AdHoc.Filter|/API/Izenda/AdHoc/Izenda-AdHoc-Filter]] at the specified index.|null|
|Object|[[Item|http://msdn.microsoft.com/en-us/library/csc83bfy]]|Gets or sets the [[Izenda.AdHoc.Filter|/API/Izenda/AdHoc/Izenda-AdHoc-Filter]] at the specified index.|null|
|String|[[SQL|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_FilterCollection_SQL]]||String.Empty|
...
###Add(Izenda.AdHoc.Filter)
Adds a [[Izenda.AdHoc.Filter|/API/Izenda/AdHoc/Izenda-AdHoc-Filter]] to the end of the [[Izenda.AdHoc.FilterCollection|/API/Izenda/AdHoc/Izenda-AdHoc-FilterCollection]].

Parameters: 

* [[Izenda.AdHoc.Filter|/API/Izenda/AdHoc/Izenda-AdHoc-Filter]] value  - The [[Izenda.AdHoc.Filter|/API/Izenda/AdHoc/Izenda-AdHoc-Filter]] to be added to the end of the [[Izenda.AdHoc.FilterCollection|/API/Izenda/AdHoc/Izenda-AdHoc-FilterCollection]].
...
The [[Izenda.AdHoc.FilterCollection|/API/Izenda/AdHoc/Izenda-AdHoc-FilterCollection]] index at which the value has been added.
...
###AddHidden(Izenda.AdHoc.Filter)
Adds a hidden [[Izenda.AdHoc.Filter|/API/Izenda/AdHoc/Izenda-AdHoc-Filter]] to the end of the [[Izenda.AdHoc.FilterCollection|/API/Izenda/AdHoc/Izenda-AdHoc-FilterCollection]].
...
Reads XML data into the [[Izenda.AdHoc.FilterCollection|/API/Izenda/AdHoc/Izenda-AdHoc-FilterCollection]] using the specified [[System.Xml.XmlReader|http://msdn.microsoft.com/en-us/library/b8a5e1s5]].
...
Reads XML data into the [[Izenda.AdHoc.FilterCollection|/API/Izenda/AdHoc/Izenda-AdHoc-FilterCollection]] from the specified [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]].
...
###WriteXml()
Writes the current data of the [[Izenda.AdHoc.FilterCollection|/API/Izenda/AdHoc/Izenda-AdHoc-FilterCollection]] to the specified [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] and returns it.
...
The XML formatted [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] for the collection of filters.
...
Writes the current data of the [[Izenda.AdHoc.FilterCollection|/API/Izenda/AdHoc/Izenda-AdHoc-FilterCollection]] to the specified XmlWriter.

Parameters: 

* [[System.Xml.XmlWriter|http://msdn.microsoft.com/en-us/library/5y8188ze]] writer  - The XML stream that will be used to write the collection of filters.
