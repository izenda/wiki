#ReportOutputGeneratorCollection
...
|:-------|:----------:|:-----------------:|:-----------:|
|String[]|[[AllKeys|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_ReportOutputGeneratorCollection_AllKeys]]|Returns a [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] array that contains all the keys  in the [[Izenda.AdHoc.ReportOutputGeneratorCollection|/API/Izenda/AdHoc/Izenda-AdHoc-ReportOutputGeneratorCollection]] instance.|[]|
|Array|[[AllValues|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_ReportOutputGeneratorCollection_AllValues]]|Returns an [[System.Object|http://msdn.microsoft.com/en-us/library/e5kfa45b]] array that contains all the values  in the [[Izenda.AdHoc.ReportOutputGeneratorCollection|/API/Izenda/AdHoc/Izenda-AdHoc-ReportOutputGeneratorCollection]] instance.|[]|
...
|Boolean|[[HasKeys|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_ReportOutputGeneratorCollection_HasKeys]]|Gets a value indicating whether the [[Izenda.AdHoc.ReportOutputGeneratorCollection|/API/Izenda/AdHoc/Izenda-AdHoc-ReportOutputGeneratorCollection]] instance  contains entries whose keys are not a null reference|False|
|ReportOutputGenerator|[[Item|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_ReportOutputGeneratorCollection_Item_-_System_String_-_]]|Gets or sets the [[Izenda.AdHoc.ReportOutputGenerator|/API/Izenda/AdHoc/Izenda-AdHoc-ReportOutputGenerator]] with the specified [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] key in the collection.|null|
...
###Add(System.String,Izenda.AdHoc.ReportOutputGenerator)
Adds an entry with the specified key and value into the [[Izenda.AdHoc.ReportOutputGeneratorCollection|/API/Izenda/AdHoc/Izenda-AdHoc-ReportOutputGeneratorCollection]] instance.
...
* [[Izenda.AdHoc.ReportOutputGenerator|/API/Izenda/AdHoc/Izenda-AdHoc-ReportOutputGenerator]] value  - The [[Izenda.AdHoc.ReportOutputGenerator|/API/Izenda/AdHoc/Izenda-AdHoc-ReportOutputGenerator]] value of the entry to add.
...
###Clear()
Removes all entries from the [[Izenda.AdHoc.ReportOutputGeneratorCollection|/API/Izenda/AdHoc/Izenda-AdHoc-ReportOutputGeneratorCollection]] instance.
...
Removes the entries with the specified key from the [[Izenda.AdHoc.ReportOutputGeneratorCollection|/API/Izenda/AdHoc/Izenda-AdHoc-ReportOutputGeneratorCollection]] instance.
...
###Remove(System.Int32)
Removes the entry at the specified index of the [[Izenda.AdHoc.ReportOutputGeneratorCollection|/API/Izenda/AdHoc/Izenda-AdHoc-ReportOutputGeneratorCollection]] instance.
