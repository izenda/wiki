...
|:-------|:----------:|:-----------------:|:-----------:|
|String|[[AppRelativeTemplateSourceDirectory|http://msdn.microsoft.com/en-us/library/y3h8d6wx]]|Gets or sets the application-relative virtual directory of the [[System.Web.UI.Page|http://msdn.microsoft.com/en-us/library/dfbt9et1]] or [[System.Web.UI.UserControl|http://msdn.microsoft.com/en-us/library/cdhdhykx]] object that contains this control.|null|
...
|String|[[ClientID|http://msdn.microsoft.com/en-us/library/4c61cw6c]]| Gets the server control identifier generated by ASP.NET. |null|
|ClientIDMode|[[ClientIDMode|http://msdn.microsoft.com/en-us/library/dd271123]]||null|
...
|Boolean|[[EnableTheming|http://msdn.microsoft.com/en-us/library/zwxc6f8d]]| Gets or sets a value indicating whether themes apply to this control. |null|
|Boolean|[[EnableViewState|http://msdn.microsoft.com/en-us/library/b3wa3sbf]]| Gets or sets a value indicating whether the server control persists its view state, and the view state of any child controls it contains, to the requesting client. |null|
...
|Version|[[RenderingCompatibility|http://msdn.microsoft.com/en-us/library/dd992688]]||null|
...
|String|[[SkinID|http://msdn.microsoft.com/en-us/library/6262k69w]]| Gets or sets the skin to apply to the control. |null|
...
|String|[[TemplateSourceDirectory|http://msdn.microsoft.com/en-us/library/18y98fcb]]|Gets the virtual directory of the [[System.Web.UI.Page|http://msdn.microsoft.com/en-us/library/dfbt9et1]] or [[System.Web.UI.UserControl|http://msdn.microsoft.com/en-us/library/cdhdhykx]] that contains the current server control.|null|
...
|ValidateRequestMode|[[ValidateRequestMode|http://msdn.microsoft.com/en-us/library/hh160854]]||null|
|ViewStateMode|[[ViewStateMode|http://msdn.microsoft.com/en-us/library/dd322375]]||null|
|Boolean|[[Visible|http://msdn.microsoft.com/en-us/library/3ad1xyzd]]| Gets or sets a value that indicates whether a server control is rendered as UI on the page. |null|
...
###GenerateMapControl(Izenda.AdHoc.Report,System.Data.DataTable)
Creates the control for adding a map based on the input [[Izenda.AdHoc.Report|/API/Izenda/AdHoc/Izenda-AdHoc-Report]] that can be inserted into a web page.

Parameters: 

* [[Izenda.AdHoc.Report|/API/Izenda/AdHoc/Izenda-AdHoc-Report]] report  - The [[Izenda.AdHoc.Report|/API/Izenda/AdHoc/Izenda-AdHoc-Report]] that will be used to render the map.
* [[System.Data.DataTable|http://msdn.microsoft.com/en-us/library/9186hy08]] formatResult  - The pre-formatted result set containing the data the map will actually use.
...
The [[System.Web.UI.Control|http://msdn.microsoft.com/en-us/library/983zwx2h]] containing the map that was built.
