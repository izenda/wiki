...
|:-------|:----------:|:-----------------:|:-----------:|
|Boolean|[[AlwaysGenerateAs|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_Driver_AlwaysGenerateAs]]| Determines whether fields will always use the "AS" keyword when generating SQL queries. |False|
|String|[[AsForTables|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_PostgreSQLDriver_AsForTables]]| Gets the PostgreSQL keyword used to separate identifiers from aliases. |String.Empty|
|String|[[CacheKeyBase|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_Driver_CacheKeyBase]]|Gets a [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] that represents a unique key that can be used to query the cache.|Izenda.AdHoc.Database.PostgreSQLDriver|
...
|String|[[DefaultSchemaName|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_Driver_DefaultSchemaName]]| Represents the name of the default schema of the DBMS for this driver. |public|
...
###ContainColumn(System.String,System.String,System.String)
 Determines whether the specified table in the schema contains the column with the specified name in the PostgreSQL database. 
...
###ContainsTableName(System.String)
 Checks to see if the specified table exists on the PostgreSQL database. 
...
Creates an [[System.Data.IDbCommand|http://msdn.microsoft.com/en-us/library/bt2afddc]] object from the specified [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] SQL statement that can be cast to an Npgsql.NpgsqlCommandCommand.
...
The [[System.Data.IDbCommand|http://msdn.microsoft.com/en-us/library/bt2afddc]].
...
###CreateConnection()
 Creates a connection to the PostgreSQL database if the connection string exists. 
...
The [[System.Data.IDbConnection|http://msdn.microsoft.com/en-us/library/bs16hf60]] created that can be cast to an [[Npgsql.NpgsqlConnection|About:blank]].
...
Creates a generically-typed [[System.Data.IDataParameter|http://msdn.microsoft.com/en-us/library/b14k9y11]] object from the specified values that can be typecast to an [[Npgsql.NpgsqlParameter|About:blank]] object.
...
Creates a [[System.Data.IDataParameter|http://msdn.microsoft.com/en-us/library/b14k9y11]] object from the specified values that can be typecast to a [[Npgsql.NpgsqlParameter|About:blank]] object.
...
###DetectVersion()
 Gets the version of the PostgreSQL database that is being connected to. 
...
The [[System.Version|http://msdn.microsoft.com/en-us/library/hdxyt63s]] representation of the PostgreSQL database version.
...
###FullStoredProceduresList()
 Gets a list of all stored procedures on the PostgreSQL database. 
...
The [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] represetation of the description that has been made safe for executing in PostgreSQL.
...
###GetAllStoredProcedures()
 Gets a list of all stored procedures on the PostgreSQL database from the VisibleDatasources. 
...
###GetAllTables()
 Gets a list of all tables and views on the PostreSQL database from the VisibleDataSources. 
...
###GetColumns(Izenda.AdHoc.Database.Table)
 Gets the complete list of columns found on the PostgreSQL database for the specified table. 
...
###GetColumns(Izenda.AdHoc.Database.StoredProcedure)
 Gets the list of columns for the specified stored procedure on the PostgreSQL database. 
...
###GetConstraints(Izenda.AdHoc.Database.DatabaseSchema)
 Gets a list of constraints for the specified database schema on the PostgreSQL database. 
...
Gets a SQL formatted [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the function used to convert the specified parameters into a PostgreSQL date.
...
Gets a PostgreSQL statement from the specified parameters that creates a [[System.Data.IDbCommand|http://msdn.microsoft.com/en-us/library/bt2afddc]] to create a report on the database.
...
Gets a PostgreSQL statement from the specified parameters that creates a [[System.Data.IDbCommand|http://msdn.microsoft.com/en-us/library/bt2afddc]] to create a report on the database. This method uses an empty tenantId.
...
Gets a [[System.Data.IDataReader|http://msdn.microsoft.com/en-us/library/sh674a6a]] object from the specified database command that can be typecast to an [[Npgsql.NpgsqlCommand|About:blank]].
...
Gets the PostgreSQL [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of a function that calculates the difference between two dates.
...
The PostgreSQL formatted [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] created from the parameters.
...
* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] part  - The PostgreSQL date portion to conver the expression into.
...
Gets a PostgreSQL statement from the specified parameters that creates a [[System.Data.IDbCommand|http://msdn.microsoft.com/en-us/library/bt2afddc]] to delete the specified report definition from the database.
...
Gets a PostgreSQL statement from the specified parameters that creates a [[System.Data.IDbCommand|http://msdn.microsoft.com/en-us/library/bt2afddc]] to get a list of reports from the database.
...
Gets a PostgreSQL statement from the specified parameters that creates a [[System.Data.IDbCommand|http://msdn.microsoft.com/en-us/library/bt2afddc]] to load the specified report definition from the database.
...
Gets a PostgreSQL statement from the specified parameters that creates a [[System.Data.IDbCommand|http://msdn.microsoft.com/en-us/library/bt2afddc]] to load the specified report definition with the specified name and tenantId from the database.
...
###GetParams(Izenda.AdHoc.Database.StoredProcedure)
 Gets the list of parameters for the specified stored procedure on the PostgreSQL database. 
...
Gets the [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the fully-qualified name of the table formatted for PostgreSQL.
...
Gets the [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the fully-qualified name of the column formatted for PostgreSQL.
...
Gets a PostgreSQL statement from the specified parameters that creates a [[System.Data.IDbCommand|http://msdn.microsoft.com/en-us/library/bt2afddc]] to update a report on the database. This method uses an empty tenantId.
...
Gets a SQL formatted [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of a PostgreSQL function to extract the year and week from the specified SQL expression.

Parameters: 

* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] expression  - The PostgreSQL [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] that the year and week should be extracted from.
...
Gets the PostgreSQL formatted [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] for the specified parameter name.
...
Gets a [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the specified value that will be formatted to be acceptible as a PostgreSQL identifier.

Parameters: 

* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] str  - The table, view, or column name to be formatted as a PostgreSQL identifier
...
Updates the PostgreSQL database table where reports are stored with the [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the HTML form used for the specified report.
