...
|String|[[AsForTables|/API/Izenda/AdHoc/Database/CodeSamples/Izenda_AdHoc_Database_OdbcDriver_AsForTables]]| Gets the ODBC keyword used to separate identifiers from aliases. |inherited from concrete class|
