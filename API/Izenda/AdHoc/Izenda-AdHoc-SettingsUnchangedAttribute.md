...
|Single|[[Version|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_SettingsUnchangedAttribute_Version]]| Gets the AdHoc key version that should be used as the version point to check from. |0|
|VersionPeriod|[[VersionShouldBe|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_SettingsUnchangedAttribute_VersionShouldBe]]|Gets the [[Izenda.AdHoc.VersionPeriod|/API/Izenda/AdHoc/Izenda-AdHoc-VersionPeriod]] that the property should be before allowing or preventing a property change.|less|
