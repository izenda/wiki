...
|:-------|:----------:|:-----------------:|:-----------:|
|String|[[FileExtension|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_JsonOutputGenerator_FileExtension]]|Gets the [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] file extension that will be appended to the finished filename.|json|
...
Generates a JSON file containing the data loaded from the specified [[Izenda.AdHoc.ReportSet|/API/Izenda/AdHoc/Izenda-AdHoc-ReportSet]].
...
An [[Izenda.Controls.IContentGenerator|/API/Izenda/Controls/Izenda-Controls-IContentGenerator]] containing the JSON file output.
