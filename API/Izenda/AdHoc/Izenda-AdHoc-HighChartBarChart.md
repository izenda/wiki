...
|:-------|:----------:|:-----------------:|:-----------:|
|BarChart|[[Chart|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_HighChartBarChart_Chart]]|Gets or sets the [[ChartOptions|/API/Izenda/Web/UI/HighCharts/CodeSamples/Izenda_Web_UI_HighCharts_BarChart_ChartOptions]] that will be used to store the chart structure and the data of the chart.|null|
...
|ChartPropertyCollection|[[Properties|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_Chart_Properties]]| Gets the collection of chart properties that are used to control various settings. |{ShowLegend, LegendPosition,<br>Pareto, Stacked,<br>Horizontal, ShadeAreaUnderLine,<br>LabelTitle, ValueTitle,<br>RightValueTitle, Scale,<br>TargetReport, HiddenEffectField,<br>Effect, ThirdMode,<br>CountInRow}|
...
###CreateDataGenerator()
 Gets the mechanism for this bar chart that loads and sorts data. 
...
###FillConfig(Izenda.AdHoc.Report)
 Initializes the configuration options for the bar chart using the specified parameters. 

Parameters: 

* [[Izenda.AdHoc.Report|/API/Izenda/AdHoc/Izenda-AdHoc-Report]] report  - The source [[Izenda.AdHoc.Report|/API/Izenda/AdHoc/Izenda-AdHoc-Report]] that this chart is based on and determines certain configuration options.
...
###GetWrappedTitle(System.String,System.Int32)


Parameters: 

* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] originalTitle 
* [[System.Int32|http://msdn.microsoft.com/en-us/library/td2s409d]] limit 
...
Draws the HTML for the chart to the [[System.Web.UI.Control|http://msdn.microsoft.com/en-us/library/983zwx2h]] for use on a web page.
...
* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] mwSet  - Used to specify whether Dundas charts will render their legends below the report.
