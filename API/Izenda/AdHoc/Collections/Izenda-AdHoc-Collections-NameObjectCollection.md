...
|:-------|:----------:|:-----------------:|:-----------:|
|T|[[Item|/API/Izenda/AdHoc/Collections/CodeSamples/Izenda_AdHoc_Collections_NameObjectCollection`1_Item_-_System_String_-_]]| Gets or sets the value of the object of type T using the specified key. |null|
