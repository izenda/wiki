...
|:-------|:----------:|:-----------------:|:-----------:|
|Boolean|[[AllowNulls|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_JoinedTableCollection_AllowNulls]]||False|
...
|JoinedTable|[[Item|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_JoinedTableCollection_Item_-_System_Int32_-_]]|Gets or sets the [[Izenda.AdHoc.JoinedTable|/API/Izenda/AdHoc/Izenda-AdHoc-JoinedTable]] at the specified index.|null|
|Object|[[Item|http://msdn.microsoft.com/en-us/library/csc83bfy]]|Gets or sets the [[Izenda.AdHoc.JoinedTable|/API/Izenda/AdHoc/Izenda-AdHoc-JoinedTable]] at the specified index.|null|
...
###Add(Izenda.AdHoc.JoinedTable)
Adds a [[Izenda.AdHoc.JoinedTable|/API/Izenda/AdHoc/Izenda-AdHoc-JoinedTable]] to the end of the [[Izenda.AdHoc.JoinedTableCollection|/API/Izenda/AdHoc/Izenda-AdHoc-JoinedTableCollection]].

Parameters: 

* [[Izenda.AdHoc.JoinedTable|/API/Izenda/AdHoc/Izenda-AdHoc-JoinedTable]] value  - The [[Izenda.AdHoc.JoinedTable|/API/Izenda/AdHoc/Izenda-AdHoc-JoinedTable]] to be added to the end of the [[Izenda.AdHoc.JoinedTableCollection|/API/Izenda/AdHoc/Izenda-AdHoc-JoinedTableCollection]].
...
The [[Izenda.AdHoc.JoinedTableCollection|/API/Izenda/AdHoc/Izenda-AdHoc-JoinedTableCollection]] index at which the value has been added.
...
Reads XML data into the [[Izenda.AdHoc.JoinedTableCollection|/API/Izenda/AdHoc/Izenda-AdHoc-JoinedTableCollection]] using the specified [[System.Xml.XmlReader|http://msdn.microsoft.com/en-us/library/b8a5e1s5]].
...
Reads XML data into the [[Izenda.AdHoc.JoinedTableCollection|/API/Izenda/AdHoc/Izenda-AdHoc-JoinedTableCollection]] from the specified [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]].
...
###SQL(System.Collections.Generic.ICollection&lt;Izenda.AdHoc.Filter&gt;,Izenda.AdHoc.FilterCollection,System.Boolean)
Gets the [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] SQL output for the JOIN portion of the report SQL

Parameters: 

* [[System.Collections.Generic.ICollection|http://msdn.microsoft.com/en-us/library/92t2ye13]]&lt;[[Izenda.AdHoc.Filter|/API/Izenda/AdHoc/Izenda-AdHoc-Filter]]&gt; joinedTablesFilters  - The collection of [[Izenda.AdHoc.Filter|/API/Izenda/AdHoc/Izenda-AdHoc-Filter]] conditions returned from the SQL generation process. These filters should be used in the WHERE clause.
* [[Izenda.AdHoc.FilterCollection|/API/Izenda/AdHoc/Izenda-AdHoc-FilterCollection]] allFilters  - The collection of all [[Izenda.AdHoc.Filter|/API/Izenda/AdHoc/Izenda-AdHoc-Filter]] conditions passed in from the report. These will be considered as extra conditions for the ON clause.
* [[System.Boolean|http://msdn.microsoft.com/en-us/library/a28wyd50]] reportSetHasFilterLogic  - Determines whether the report is using filter logic. When true, table filters will not be added to the ON clause.
...
A [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] representation of the generated SQL for the JOINs in the report.
...
###WriteXml()
Writes the current data of the [[Izenda.AdHoc.JoinedTableCollection|/API/Izenda/AdHoc/Izenda-AdHoc-JoinedTableCollection]] to the specified [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] and returns it.
...
Writes the current data of the [[Izenda.AdHoc.JoinedTableCollection|/API/Izenda/AdHoc/Izenda-AdHoc-JoinedTableCollection]] to the specified XmlWriter.
