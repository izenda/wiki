...
|:-------|:----------:|:-----------------:|:-----------:|
|String|[[FileExtension|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_JsonArraysOutputGenerator_FileExtension]]|Gets the [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] file extension that will be appended to the finished filename.|js|
...
Generates a JS file containing the JSON data loaded from the specified [[Izenda.AdHoc.ReportSet|/API/Izenda/AdHoc/Izenda-AdHoc-ReportSet]].
...
An [[Izenda.Controls.IContentGenerator|/API/Izenda/Controls/Izenda-Controls-IContentGenerator]] containing the JSON formatted arrays with javascript variable notation.
...
###GetOutputFileName(System.String)
 Gets the filename that will be given to the report with the specified name. 

Parameters: 

* [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] reportTitle  - The name of the report.
...
The complete filename of the output file.
