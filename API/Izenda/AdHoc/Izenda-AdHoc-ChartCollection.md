...
|:-------|:----------:|:-----------------:|:-----------:|
|String[]|[[AllKeys|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_ChartCollection_AllKeys]]|Returns a [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] array that contains all the keys  in the [[Izenda.AdHoc.ChartCollection|/API/Izenda/AdHoc/Izenda-AdHoc-ChartCollection]] instance.|[]|
|Array|[[AllValues|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_ChartCollection_AllValues]]|Returns an [[System.Object|http://msdn.microsoft.com/en-us/library/e5kfa45b]] array that contains all the values  in the [[Izenda.AdHoc.ChartCollection|/API/Izenda/AdHoc/Izenda-AdHoc-ChartCollection]] instance.|[]|
|Chart|[[Chart|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_ChartCollection_Chart]]||null|
...
|Boolean|[[HasKeys|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_ChartCollection_HasKeys]]|Gets a value indicating whether the [[Izenda.AdHoc.ChartCollection|/API/Izenda/AdHoc/Izenda-AdHoc-ChartCollection]] instance  contains entries whose keys are not a null reference|False|
|Chart|[[Item|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_ChartCollection_Item_-_System_String_-_]]|Gets the value of the first entry with the specified key  from the [[Izenda.AdHoc.ChartCollection|/API/Izenda/AdHoc/Izenda-AdHoc-ChartCollection]] instance.|null|
...
###Add(System.String,Izenda.AdHoc.Chart)
Adds an entry with the specified key and value into the [[Izenda.AdHoc.ChartCollection|/API/Izenda/AdHoc/Izenda-AdHoc-ChartCollection]] instance.
...
* [[Izenda.AdHoc.Chart|/API/Izenda/AdHoc/Izenda-AdHoc-Chart]] value  - The [[Izenda.AdHoc.Chart|/API/Izenda/AdHoc/Izenda-AdHoc-Chart]] value of the entry to add.
...
###Clear()
Removes all entries from the [[Izenda.AdHoc.ChartCollection|/API/Izenda/AdHoc/Izenda-AdHoc-ChartCollection]] instance.
...
Removes the entries with the specified key from the [[Izenda.AdHoc.ChartCollection|/API/Izenda/AdHoc/Izenda-AdHoc-ChartCollection]] instance.
...
###Remove(System.Int32)
Removes the entry at the specified index of the [[Izenda.AdHoc.ChartCollection|/API/Izenda/AdHoc/Izenda-AdHoc-ChartCollection]] instance.
