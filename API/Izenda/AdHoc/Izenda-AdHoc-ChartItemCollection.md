...
|ChartItem|[[Item|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_ChartItemCollection_Item_-_System_Int32_-_]]|Gets or sets the [[Izenda.AdHoc.ChartItem|/API/Izenda/AdHoc/Izenda-AdHoc-ChartItem]] at the specified index.|null|
|Object|[[Item|http://msdn.microsoft.com/en-us/library/csc83bfy]]|Gets or sets the [[Izenda.AdHoc.ChartItem|/API/Izenda/AdHoc/Izenda-AdHoc-ChartItem]] at the specified index.|null|
...
###Add(Izenda.AdHoc.ChartItem)
Appends the specified [[Izenda.AdHoc.ChartItem|/API/Izenda/AdHoc/Izenda-AdHoc-ChartItem]] onto the end of the collection of chart items.

Parameters: 

* [[Izenda.AdHoc.ChartItem|/API/Izenda/AdHoc/Izenda-AdHoc-ChartItem]] value  - The chart item to add to the collection.
