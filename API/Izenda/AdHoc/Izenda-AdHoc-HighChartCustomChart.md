...
|String|[[Name|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_Chart_Name]]| Gets or sets the name that identifies what type of chart is being created. |Custom|
|ChartPropertyCollection|[[Properties|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_Chart_Properties]]| Gets the collection of chart properties that are used to control various settings. |{CustomScript, Mode,<br>ThirdMode, CountInRow}|
...
###CreateDataGenerator()
 Gets the mechanism for this chart that loads and formats data. 
...
###SetIsAnimationEnabled(System.Boolean)
 Sets whether or not chart animations will be used after rendering. 

Parameters: 

* [[System.Boolean|http://msdn.microsoft.com/en-us/library/a28wyd50]] enabled  - Whether animations will be enabled for this chart.
