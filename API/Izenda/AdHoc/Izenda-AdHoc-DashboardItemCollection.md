...
|DashboardItem|[[Item|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_DashboardItemCollection_Item_-_System_Int32_-_]]|Gets or sets the [[Izenda.AdHoc.DashboardItem|/API/Izenda/AdHoc/Izenda-AdHoc-DashboardItem]] at the specified index.|null|
|Object|[[Item|http://msdn.microsoft.com/en-us/library/csc83bfy]]|Gets or sets the [[Izenda.AdHoc.DashboardItem|/API/Izenda/AdHoc/Izenda-AdHoc-DashboardItem]] at the specified index.|null|
...
###Add(Izenda.AdHoc.DashboardItem)
Adds a [[Izenda.AdHoc.DashboardItem|/API/Izenda/AdHoc/Izenda-AdHoc-DashboardItem]] to the end of the [[Izenda.AdHoc.DashboardItemCollection|/API/Izenda/AdHoc/Izenda-AdHoc-DashboardItemCollection]].

Parameters: 

* [[Izenda.AdHoc.DashboardItem|/API/Izenda/AdHoc/Izenda-AdHoc-DashboardItem]] value  - The [[Izenda.AdHoc.DashboardItem|/API/Izenda/AdHoc/Izenda-AdHoc-DashboardItem]] to be added to the end of the [[Izenda.AdHoc.DashboardItemCollection|/API/Izenda/AdHoc/Izenda-AdHoc-DashboardItemCollection]].
...
The [[Izenda.AdHoc.DashboardItemCollection|/API/Izenda/AdHoc/Izenda-AdHoc-DashboardItemCollection]] index at which the value has been added.
...
Gets the [[Izenda.AdHoc.DashboardItem|/API/Izenda/AdHoc/Izenda-AdHoc-DashboardItem]] at the specified column and row index.

Parameters: 

* [[System.Int32|http://msdn.microsoft.com/en-us/library/td2s409d]] x  - The column index.
* [[System.Int32|http://msdn.microsoft.com/en-us/library/td2s409d]] y  - The row index.
...
The [[Izenda.AdHoc.DashboardItem|/API/Izenda/AdHoc/Izenda-AdHoc-DashboardItem]] located at the specified column and row. Returns null if the item cannot be found in the collection.
