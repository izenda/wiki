...
|:-------|:----------:|:-----------------:|:-----------:|
|String[]|[[AllKeys|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_ReportSetResults_AllKeys]]|Gets a list of the [[System.String|http://msdn.microsoft.com/en-us/library/s1wwdcbf]] keys that are contained in the collection.|[]|
|Array|[[AllValues|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_ReportSetResults_AllValues]]| Gets a list of all the AdHoc.ReportQueryExecuteResult values that are contained in the collection. |[]|
...
|Boolean|[[HasKeys|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_ReportSetResults_HasKeys]]| Determines whether the collection contains any keys. |False|
|ReportQueryExecuteResult|[[Item|/API/Izenda/AdHoc/CodeSamples/Izenda_AdHoc_ReportSetResults_Item_-_System_String_-_]]| Gets or sets the AdHoc.ReportQueryExecuteResult in the collection using the specified key. |null|
...
###Add(System.String,Izenda.AdHoc.Database.ReportQueryExecuteResult)
 Appends the specified AdHoc.ReportQueryExecuteResult to the end of the collection. 
...
* [[Izenda.AdHoc.Database.ReportQueryExecuteResult|/API/Izenda/AdHoc/Database/Izenda-AdHoc-Database-ReportQueryExecuteResult]] value  - The AdHoc.ReportQueryExecuteResult to insert into the collection.
...
###GetMD5HashCode()
 Gets an MD5 checksum value from the data in the AdHoc.ReportQueryExecuteResult items in the collection. 
