...
_**Note:** Earlier versions of Izenda reports only allow one drilldown key to be used. This works just like using two except without the ability to ignore one._
