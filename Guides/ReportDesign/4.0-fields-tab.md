...
|VG check box|When checked, this option will cause the field that it is checked for to be separated into subheadings. This can better allow report viewers to easily see related data. See more about [[visual groups|/Guides/ReportDesign/10.0-Style-tab#10.5-Visual-Group-Styles]].|
