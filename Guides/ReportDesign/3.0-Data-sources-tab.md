...
In Advanced Mode, you will have to select the relationships that exist between the tables or views yourself. You will start with a drop-down menu that lists the various Tables and Views that are available. The following section requires basic knowledge of database terminology.

![The Primary Table Dropdown Menu]()
...
![The Foreign Table Dropdown Menu]()
...
**Admins:** See Section 3.2 for information on how to show this field (off by default).
...
Since Izenda is a platform and not a set product, if the Simple or Advanced Modes do not fit your needs, you can have a customized Data Source Selection Page tailored to your preferences.  The example below demonstrates a custom implementation using report categories to filter hundreds of tables and views to make the process even easier for end-users.
