...
When the chart type is None (…), no chart appears. If you want to remove a chart from a report, choose this option.

![None Selection]()

##7.2 Trend Selection

Selecting a Trend chart type will generate a line graph with a number of different options to choose from on your report.
