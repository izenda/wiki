...
|:----|:-----------|:----------------|:---------------|
|HF 25952|Report Design|Dashboards|Fixed "refresh tile" button visibility.|
|HF 25959|Database|MySQL|Fixed missing filter on Date/Time columns in ODBC drivers.|
