...
|**Date/Time**        |Between (Calendar)      |Allows you to select two dates from a calendar popup to filter on. This can be changed to a manual text entry field by modifying the ShowBetweenDateCalendar in the [[AdHocSettings|/Library/AdHocSettings]].
