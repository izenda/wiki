...
|Multiline Header|'Multiline Header' allows a header to be multi-lined if the length of header is longer than set width of the column. Each space between words works as a line breaker| 
